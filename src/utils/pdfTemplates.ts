 ...
 * Used by all PDF export modules in TillCalc.
 *
...
<div class="ph">
  <div class="ph-l">
    ...
    <div class="ph-brand">
      <span class="ph-name">${escHtml(i18n.t('appName', { defaultValue: 'TillCalc' }))}</span>
 ...
 * Right column always reads "Generated by TillCalc".
 */
...
<div class="pdf-footer">
  ...
  <span>${pageNum !== '' ? `${escHtml(i18n.t('common.generatedBy', { defaultValue: 'Generated by TillCalc' }))} &middot; ${escHtml(i18n.t('common.page', { defaultValue: 'Page' }))} ${pageNum}` : escHtml(i18n.t('common.generatedBy', { defaultValue: 'Generated by TillCalc' }))}</span>
</div>`;
}
